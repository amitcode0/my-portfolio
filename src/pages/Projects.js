  ...
  const projects = [
    {
      ...
      image: "/assets/android-reverse-shell.jpg", // ✅ Correct path
      tags: ["msfvenom", "Metasploit", "Kali Linux"],
      category: "mobile", // ✅ Fixed case - should be lowercase to match filter
    ...
    },
    {
      ...
      image: "/assets/paytm-upi-analyzer.png", // ✅ Correct path
    ...
    },
    {
      ...
      image: "/assets/gym.png", // ✅ Fixed - removed /src/ prefix
